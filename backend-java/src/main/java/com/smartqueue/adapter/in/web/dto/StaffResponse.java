...
public record StaffResponse(String id, String shopId, String name, String phone, boolean active, boolean onDuty) {

    public static StaffResponse from(User u) {
        return new StaffResponse(u.id(), u.shopId(), u.name(), u.phone(), u.active(), u.onDuty());
    }
}
